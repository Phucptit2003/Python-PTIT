...
def recognize_speech():
    ...
    if file_path:
        if file_path.lower().endswith(".wav") and os.path.isfile(file_path):#Kiểm tra xem file được chọn có phải là file WAV và có tồn tại không.
            with sr.AudioFile(file_path) as source:
                audio_data = recognizer.record(source)#Sử dụng sr.AudioFile để mở file âm thanh và recognizer.record để ghi âm và lấy dữ liệu âm thanh.
                try:
                    text = recognizer.recognize_google(audio_data, language=source_language_var.get()) #Sử dụng recognizer.recognize_google để nhận dạng giọng nói qua API của Google.
...
def recognize_and_insert_text():
    ...
    if file_path:
        ...
        recognized_text = ""
        for (bbox, text, prob) in result: #Sử dụng reader.readtext để đọc văn bản từ hình ảnh và lưu kết quả vào result.Duyệt qua các kết quả (bbox: vùng giới hạn, text: văn bản nhận dạng, prob: xác suất).Nối các từ đã nhận dạng lại vào biến recognized_text.
...
# root.iconbitmap('C:\\Users\\phucl\\OneDrive\\Desktop\\Python\\icon.ico') 


# Tạo nền
frame1 = Frame(root, width=1000, height=500, relief=RIDGE, bg="#F0EDE6")
frame1.place(x=0, y=0)
background = ImageTk.PhotoImage(Image.open("C:\\Users\\phucl\\OneDrive\\Desktop\\Python\\background.png"))
...
newsize_trans = (35, 35)
# Nút dịch
btn1_img = Image.open("C:\\Users\\phucl\\OneDrive\\Desktop\\Python\\translate_icon.png")
...
# Nút xoá
btn2_img = Image.open("C:\\Users\\phucl\\OneDrive\\Desktop\\Python\\clear_icon.png")
...
volume_target_img = Image.open("C:\\Users\\phucl\\OneDrive\\Desktop\\Python\\volume_icon.png")
...
volume_source_img = Image.open("C:\\Users\\phucl\\OneDrive\\Desktop\\Python\\volume_icon.png")
...
# Nút "Scan"
scan_img = Image.open("C:\\Users\\phucl\\OneDrive\\Desktop\\Python\\picture_icon.png")
...
wav_img = Image.open("C:\\Users\\phucl\\OneDrive\\Desktop\\Python\\file_icon.png")
